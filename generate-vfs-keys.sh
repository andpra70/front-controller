...
AUTH_KEYS="$SCRIPT_DIR/../app/oauth-server/keys"
VFS_KEYS="$SCRIPT_DIR/../app/fileserver/keys"
...
echo "RS256 key pair generated. Keep app/oauth-server/keys/private.pem secret."
